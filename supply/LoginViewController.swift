...
class LoginViewController: UIViewController {
    ...
    let logoContainerView: UIView = {
        ...
        logoImageView.image = UIImage(named:"supplylogo1.png")
        ...
        view.backgroundColor = UIColor.rgb(red:85, green: 72, blue: 135)
        return view
    }()
    ...
    @objc func handleTextInputChange() {
        ...
        if isFormValid {
            ...
            loginButton.backgroundColor = UIColor.rgb(red:85, green: 72, blue: 135)
        } else {
